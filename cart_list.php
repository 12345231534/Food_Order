        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Danh sách sản phẩm</b></div>
		        				<div class="col-md-4 text-right"><b>Thành tiền</b></div>
	        				</div>
	        			</div>
	        		</div>
	        	</div>
        	...
        	<div class="col-md-4">
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					<p><large>Tổng tiền</large></p>
        					<hr>
        					<p class="text-right"><b><?php echo number_format($total,2) ?></b></p>
        					<hr>
        					<div class="text-center">
        						<button class="btn btn-block btn-outline-dark" type="button" id="checkout">Xác nhận thanh toán</button>
        					</div>
        				</div>
        			</div>
        		</div>
