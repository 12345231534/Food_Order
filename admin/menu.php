					...
					<div class="card-body">
							...
							<div class="form-group">
								<div class="custom-control custom-switch">
								  ...
								  <label class="custom-control-label" for="availability">Sẵn có</label>
								</div>
							</div>	
							<div class="form-group">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Tên sản phẩm : <b><?php echo $row['name'] ?></b></p>
										<p>Danh mục : <b><?php echo $row['cat'] ?></b></p>
										<p>Mô tả : <b class="truncate"><?php echo $row['description'] ?></b></p>
