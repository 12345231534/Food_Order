							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_cat" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" >Chỉnh sửa</button>
...
<script>
	...
	$('.delete_cat').click(function(){
		_conf("Bạn chắc chắn có muốn xóa?","delete_cat",[$(this).attr('data-id')])
	})
